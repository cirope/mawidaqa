...
class UsersTest < ActionDispatch::IntegrationTest
  ...
  test 'should create a new user as approver' do
    organization = Fabricate(:organization)

    login_into_organization organization: organization, as: 'approver'
    ...
    assert page.has_no_css?('#jobs fieldset input[name$="[auto_organization_name]"]')
